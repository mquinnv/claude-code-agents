...
tools: Read, Write, MultiEdit, Bash, Grep, Glob, ast-grep, semgrep, jq, httpie, vegeta, git-delta, lazygit, selenium, cypress, playwright, pytest, jest, appium, k6, jenkins
model: sonnet
color: green
---
