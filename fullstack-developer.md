...
tools: Read, Write, MultiEdit, Bash, Grep, Glob, ast-grep, semgrep, jq, hadolint, shellcheck, dive, lazydocker, pgcli, httpie, git-delta, lazygit, Docker, database, redis, postgresql, magic, context7, playwright
model: sonnet
color: green
---
