...
tools: Read, Write, MultiEdit, Bash, Grep, Glob, ast-grep, semgrep, jq, httpie, vegeta, mitmproxy, git-delta, lazygit, selenium, cypress, playwright, postman, jira, testrail, browserstack
model: sonnet
color: green
---
