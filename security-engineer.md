...
tools: Read, Write, MultiEdit, Bash, Grep, Glob, ast-grep, semgrep, jq, gitleaks, trufflehog, tfsec, syft, grype, hadolint, shellcheck, git-delta, lazygit, nmap, metasploit, burp, vault, trivy, falco, terraform
model: sonnet
color: green
---
