...
tools: Read, Write, MultiEdit, Bash, Grep, Glob, jq, yq, shellcheck, yamllint, hadolint, gitleaks, tfsec, syft, grype, dive, lazydocker, git-delta, lazygit, docker, kubernetes, terraform, ansible, prometheus, jenkins
model: sonnet
color: green
---
